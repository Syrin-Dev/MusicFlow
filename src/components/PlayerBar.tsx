                ...
                <div className="backdrop-blur-md bg-black/20 border border-white/5 rounded-2xl p-3 flex items-center justify-between shadow-[0_8px_32px_rgba(0,0,0,0.5)] pointer-events-auto mx-auto max-w-screen-2xl w-full">
                    ...
                    <div className="flex items-center gap-4 w-1/4 min-w-[200px]">
                        ...
                        <div className="flex flex-col min-w-0">
                            <div className="flex items-center gap-2">
                                <button
                                    className="text-white font-bold text-sm hover:underline cursor-pointer truncate max-w-[150px] text-left focus-visible:ring-2 focus-visible:ring-[#8B5CF6] focus-visible:outline-none rounded"
                                    onClick={togglePlayerExpansion}
                                ...
                                <button
                                    ...
                                    aria-pressed={liked}
                                    className="focus-visible:ring-2 focus-visible:ring-[#8B5CF6] focus-visible:outline-none rounded-full p-1"
                                >
                    ...
                    <div className="flex flex-col items-center flex-1 max-w-2xl px-8">
                        <div className="flex items-center gap-6 mb-1">
                            <button
                                className={`transition focus-visible:ring-2 focus-visible:ring-[#8B5CF6] focus-visible:outline-none rounded-full p-1 ${shuffle ? 'text-[#8B5CF6] drop-shadow-[0_0_5px_rgba(139,92,246,0.5)]' : 'text-gray-400 hover:text-white'}`}
                            ...
                            <button
                                className="text-gray-300 hover:text-white transition focus-visible:ring-2 focus-visible:ring-[#8B5CF6] focus-visible:outline-none rounded-full p-1"
                            ...
                            <button
                                className={`transition focus-visible:ring-2 focus-visible:ring-[#8B5CF6] focus-visible:outline-none rounded-full p-1 ${repeat !== 'off' ? 'text-[#8B5CF6] drop-shadow-[0_0_5px_rgba(139,92,246,0.5)]' : 'text-gray-400 hover:text-white'}`}
                                onClick={toggleRepeat}
                                aria-label={`Toggle repeat (current: ${repeat})`}
                    ...
                    <div className="flex items-center justify-end gap-3 w-1/4 min-w-[200px]">
                        ...
                        <button
                            className="text-gray-400 hover:text-white transition ml-2 focus-visible:ring-2 focus-visible:ring-[#8B5CF6] focus-visible:outline-none rounded-full p-1"
                            onClick={togglePlayerExpansion}
                            title="Expand"

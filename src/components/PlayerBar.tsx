        ...
        <div suppressHydrationWarning className="fixed bottom-0 left-0 right-0 z-50 pointer-events-none">
                ...
                <div className="backdrop-blur-md bg-black/20 border border-white/5 rounded-2xl p-3 flex items-center justify-between shadow-[0_8px_32px_rgba(0,0,0,0.5)] pointer-events-auto mx-auto max-w-screen-2xl w-full">
                    ...
                    <div className="flex items-center gap-4 w-1/4 min-w-[200px]">
                        ...
                        <div className="flex flex-col min-w-0">
                            <div className="flex items-center gap-2">
                                ...
                                <button aria-label={liked ? "Unlike track" : "Like track"} onClick={() => toggleLike(currentTrack)}>
                    ...
                    <div className="flex flex-col items-center flex-1 max-w-2xl px-8">
                        <div className="flex items-center gap-6 mb-1">
                            ...
                            <button
                                aria-label={repeat === 'one' ? "Disable repeat" : repeat === 'all' ? "Repeat one" : "Enable repeat"}
                        ...
                        <div className="w-full flex items-center gap-3 text-xs font-medium text-gray-400">
                            ...
                            <div
                                ...
                                className="flex-1 h-1 bg-white/10 rounded-full cursor-pointer group relative overflow-visible focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#8B5CF6] focus-visible:ring-offset-2 focus-visible:ring-offset-black"
                                onClick={handleSeek}
                                onKeyDown={(e) => {
                                    if (!duration) return;
                                    ...
                                    if (e.key === 'ArrowRight') {
                                        e.preventDefault();
                                        seekTo(Math.min(currentTime + seekAmount, duration));
                                    } else if (e.key === 'ArrowLeft') {
                                        e.preventDefault();
                                        seekTo(Math.max(currentTime - seekAmount, 0));
                                    }
                                }}
                            >
                    ...
                    <div className="flex items-center justify-end gap-3 w-1/4 min-w-[200px]">
                        ...
                        <div className="flex items-center gap-2 group w-24">
                            <button aria-label={volume === 0 ? "Unmute" : "Mute"} onClick={() => setVolume(volume === 0 ? 100 : 0)}>
            ...
            <div className="flex md:hidden px-2 pb-[calc(70px+16px+12px+env(safe-area-inset-bottom))] w-full">
                ...
                <div
                    ...
                    tabIndex={0}
                    aria-label="Expand player"
                    className="backdrop-blur-md bg-black/20 rounded-xl p-2 flex items-center justify-between shadow-2xl pointer-events-auto border border-white/5 w-full relative overflow-hidden cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#8B5CF6]"
                    onClick={togglePlayerExpansion}
                    onKeyDown={(e) => {

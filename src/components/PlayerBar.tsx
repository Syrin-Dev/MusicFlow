    ...
    return (
        <div suppressHydrationWarning className="fixed bottom-0 left-0 right-0 z-50 pointer-events-none">
                ...
                <div className="backdrop-blur-md bg-black/20 border border-white/5 rounded-2xl p-3 flex items-center justify-between shadow-[0_8px_32px_rgba(0,0,0,0.5)] pointer-events-auto mx-auto max-w-screen-2xl w-full">
                        ...
                        <div className="flex flex-col min-w-0">
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    className="focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none rounded-full"
                                >
                    ...
                    <div className="flex flex-col items-center flex-1 max-w-2xl px-8">
                        <div className="flex items-center gap-6 mb-1">
                            <button
                                className={`transition focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none rounded-full ${shuffle ? 'text-[#8B5CF6] drop-shadow-[0_0_5px_rgba(139,92,246,0.5)]' : 'text-gray-400 hover:text-white'}`}
                            ...
                            <button
                                className="text-gray-300 hover:text-white transition focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none rounded-full"
                            ...
                            <button
                                className={`transition focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none rounded-full ${repeat !== 'off' ? 'text-[#8B5CF6] drop-shadow-[0_0_5px_rgba(139,92,246,0.5)]' : 'text-gray-400 hover:text-white'}`}
                                onClick={toggleRepeat}
                                aria-label={repeat === 'one' ? 'Disable repeat one' : repeat === 'all' ? 'Enable repeat one' : 'Enable repeat all'}
                            >
                        ...
                        <div className="w-full flex items-center gap-3 text-xs font-medium text-gray-400">
                            ...
                            <div
                                className="flex-1 h-1 bg-white/10 rounded-full cursor-pointer group relative overflow-hidden focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none"
                                onClick={handleSeek}
                                role="slider"
                                tabIndex={0}
                    ...
                    <div className="flex items-center justify-end gap-3 w-1/4 min-w-[200px]">
                        <button
                            className="text-gray-400 hover:text-[#8B5CF6] transition p-2 hover:bg-white/5 rounded-full focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none"
                        ...
                        <button
                            className="text-gray-400 hover:text-white transition ml-2 focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none rounded-full"
                            onClick={togglePlayerExpansion}
                            title="Expand"
            ...
            <div className="flex md:hidden px-2 pb-[calc(70px+16px+12px+env(safe-area-inset-bottom))] w-full">
                {/* Glassmorphism update: Added backdrop-blur-md and bg-black/20 */}
                <div
                    className="backdrop-blur-md bg-black/20 rounded-xl p-2 flex items-center justify-between shadow-2xl pointer-events-auto border border-white/5 w-full relative overflow-hidden focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none"
                    onClick={togglePlayerExpansion}
                    role="button"
                    tabIndex={0}
                    aria-label="Expand player"
                ...
                >
                    ...
                    <div className="flex items-center gap-1">
                        <button
                            className="p-2 text-zinc-400 hover:text-white focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none rounded-full"
                            onClick={(e) => {
                                e.stopPropagation();
                        ...
                        <button
                            className="w-10 h-10 flex items-center justify-center text-white focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none rounded-full"
                            onClick={(e) => {
                                e.stopPropagation();
                                togglePlay();
                            }}

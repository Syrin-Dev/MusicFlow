                    ...
                    <div className="flex items-center gap-4 w-1/4 min-w-[200px]">
                        <div className="relative group">
                            ...
                            <button
                                ...
                                aria-label={`Expand player showing ${currentTrack.title}`}
                                title={`Expand player showing ${currentTrack.title}`}
                            >
                    ...
                    <div className="flex flex-col items-center flex-1 max-w-2xl px-8">
                        <div className="flex items-center gap-6 mb-1">
                            ...
                            <button
                                ...
                                title={repeat === 'one' ? "Disable repeat" : repeat === 'all' ? "Repeat one" : "Enable repeat"}
                            >

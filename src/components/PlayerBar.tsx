                ...
                <div className="backdrop-blur-md bg-black/20 border border-white/5 rounded-2xl p-3 flex items-center justify-between shadow-[0_8px_32px_rgba(0,0,0,0.5)] pointer-events-auto mx-auto max-w-screen-2xl w-full">
                    ...
                    <div className="flex flex-col items-center flex-1 max-w-2xl px-8">
                        <div className="flex items-center gap-6 mb-1">
                            ...
                            >
                                {isLoading ? (
                                    <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin" aria-label="Loading track"></div>
                                ) : (
                            ...
                            <button
                                ...
                                aria-label={repeat === 'one' ? "Disable repeat" : repeat === 'all' ? "Repeat current track" : "Enable repeat"}
                                title={repeat === 'one' ? "Disable repeat" : repeat === 'all' ? "Repeat current track" : "Enable repeat"}
                            >
            ...
            <div className="flex md:hidden px-2 pb-[calc(70px+16px+12px+env(safe-area-inset-bottom))] w-full">
                ...
                >
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        >
                            {isLoading ? (
                                <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" aria-label="Loading track"></div>
                            ) : (

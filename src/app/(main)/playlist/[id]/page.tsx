...
export default function PlaylistPage() {
    ...
    return (
        <div className="flex-1 bg-[#0A0A0B] overflow-y-auto pb-32">
            ...
            {/* Header */}
            <div className="relative h-[45vh] min-h-[350px] flex flex-col justify-between p-8 bg-gradient-to-b from-slate-800 to-[#0A0A0B]">
                ...
                <div className="flex flex-col md:flex-row items-end md:items-end gap-8 z-10 w-full">
                    {/* Cover Art */}
                    <div className="w-52 h-52 md:w-64 md:h-64 rounded-2xl shadow-2xl shadow-black/50 overflow-hidden flex-shrink-0">
                    ...
                    <div className="flex-1 mb-2 min-w-0">
                        ...
                        <h1 className="text-3xl md:text-5xl font-black text-white tracking-tight mb-4 leading-tight line-clamp-2">
                            {playlist.title}
                        </h1>
                        <p className="text-base text-white/60 line-clamp-2 max-w-2xl mb-4 font-medium">
            ...
            {/* Actions */}
            <div className="px-8 py-6 flex items-center gap-4 sticky top-0 bg-[#0A0A0B]/95 backdrop-blur-xl z-30 border-b border-white/5">
                <button
                    onClick={playAll}
                    disabled={tracks.length === 0}
                    className="w-14 h-14 rounded-full bg-[#8B5CF6] text-white flex items-center justify-center shadow-lg shadow-violet-500/30 hover:scale-105 transition-transform disabled:opacity-50 disabled:cursor-not-allowed"
                >

                ...
                <div className="backdrop-blur-md bg-black/20 border border-white/5 rounded-2xl p-3 flex items-center justify-between shadow-[0_8px_32px_rgba(0,0,0,0.5)] pointer-events-auto mx-auto max-w-screen-2xl w-full">
                    ...
                    <div className="flex flex-col items-center flex-1 max-w-2xl px-8">
                        <div className="flex items-center gap-6 mb-1">
                            ...
                            <button
                                className="group-btn w-10 h-10 bg-[#8B5CF6] rounded-full flex items-center justify-center text-white hover:scale-105 transition shadow-[0_0_15px_rgba(139,92,246,0.4)] focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none"
                                onClick={togglePlay}
                                disabled={isLoading}
                            ...
                            <button
                                ...
                                aria-label={repeat === 'one' ? 'Repeat one' : 'Repeat all'}
            ...
            <div className="flex md:hidden px-2 pb-[calc(70px+16px+12px+env(safe-area-inset-bottom))] w-full">
                ...
                >
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <button
                            className="w-10 h-10 flex items-center justify-center text-white focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none"
                            onClick={(e) => {
                                e.stopPropagation();
                                togglePlay();
                            }}

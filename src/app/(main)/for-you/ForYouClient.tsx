...
export function ForYouClient({ recommendations, personalized, context }: ForYouClientProps) {
    ...
    const handleContextChange = (newContext: string) => {
        router.push(`/for-you?context=${newContext}`);
    };
                                ...
                                >
                                    <div className="relative w-12 h-12 flex-shrink-0">
                                        <Image
                                            ...
                                            fill
                                            sizes="48px"
                                            className="rounded md:rounded object-cover shadow-sm"
                                        />
                                    </div>

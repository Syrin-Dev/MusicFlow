                ...
                <div className="backdrop-blur-md bg-black/20 border border-white/5 rounded-2xl p-3 flex items-center justify-between shadow-[0_8px_32px_rgba(0,0,0,0.5)] pointer-events-auto mx-auto max-w-screen-2xl w-full">
                        ...
                        <div className="flex flex-col min-w-0">
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    className="focus-visible:ring-2 focus-visible:ring-[#8B5CF6] rounded"
                                >
                    ...
                    <div className="flex flex-col items-center flex-1 max-w-2xl px-8">
                        <div className="flex items-center gap-6 mb-1">
                            <button
                                className={`transition focus-visible:ring-2 focus-visible:ring-[#8B5CF6] rounded ${shuffle ? 'text-[#8B5CF6] drop-shadow-[0_0_5px_rgba(139,92,246,0.5)]' : 'text-gray-400 hover:text-white'}`}
                            ...
                            <button
                                className="text-gray-300 hover:text-white transition focus-visible:ring-2 focus-visible:ring-[#8B5CF6] rounded-full"
                            ...
                            <button
                                className="w-10 h-10 bg-[#8B5CF6] rounded-full flex items-center justify-center text-white hover:scale-105 transition shadow-[0_0_15px_rgba(139,92,246,0.4)] focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black"
                                onClick={togglePlay}
                                disabled={isLoading}
                                aria-label={isPlaying ? 'Pause' : 'Play'}
                            >
                                {isLoading ? (
                                    <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin" aria-label="Loading audio"></div>
                                ) : (
                            ...
                            <button
                                className={`transition focus-visible:ring-2 focus-visible:ring-[#8B5CF6] rounded ${repeat !== 'off' ? 'text-[#8B5CF6] drop-shadow-[0_0_5px_rgba(139,92,246,0.5)]' : 'text-gray-400 hover:text-white'}`}
                        ...
                        <div className="w-full flex items-center gap-3 text-xs font-medium text-gray-400">
                            ...
                            <div
                                className="flex-1 h-1 bg-white/10 rounded-full cursor-pointer group relative overflow-visible focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#8B5CF6] focus-visible:ring-offset-2 focus-visible:ring-offset-black/20"
                                onClick={handleSeek}
                                role="slider"
                                tabIndex={0}
                                aria-valuemin={0}
                    ...
                    <div className="flex items-center justify-end gap-3 w-1/4 min-w-[200px]">
                        <button
                            className="text-gray-400 hover:text-[#8B5CF6] transition p-2 hover:bg-white/5 rounded-full focus-visible:ring-2 focus-visible:ring-[#8B5CF6]"
                        ...
                        <div className="flex items-center gap-2 group w-24">
                            <button
                                ...
                                className="focus-visible:ring-2 focus-visible:ring-[#8B5CF6] rounded-full flex items-center justify-center p-1"
                            >
                            ...
                            <div className="flex-1 h-1 bg-white/10 rounded-full cursor-pointer relative group-volume">
                                ...
                                />
                                <div
                                    className="absolute top-0 left-0 h-full bg-white group-hover:bg-[#8B5CF6] rounded-full transition-colors pointer-events-none"
                                    style={{ width: `${volume}%` }}
                                ></div>
                            </div>
                        </div>
                        ...
                        <button
                            className="text-gray-400 hover:text-white transition ml-2 focus-visible:ring-2 focus-visible:ring-[#8B5CF6] rounded-full p-1"
                            onClick={togglePlayerExpansion}
                            title="Expand Player"
            ...
            <div className="flex md:hidden px-2 pb-[calc(70px+16px+12px+env(safe-area-inset-bottom))] w-full">
                ...
                >
                    ...
                    <div className="flex items-center gap-1">
                        <button
                            className="p-2 text-zinc-400 hover:text-white focus-visible:ring-2 focus-visible:ring-[#8B5CF6] rounded-full"
                            onClick={(e) => {
                                e.stopPropagation();
                        ...
                        <button
                            className="w-10 h-10 flex items-center justify-center text-white focus-visible:ring-2 focus-visible:ring-[#8B5CF6] rounded-full"
                            onClick={(e) => {
                                e.stopPropagation();
                                togglePlay();
                            }}
                        ...
                        >
                            {isLoading ? (
                                <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" aria-label="Loading audio"></div>
                            ) : (

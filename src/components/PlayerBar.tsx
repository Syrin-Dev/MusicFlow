                    ...
                    <div className="flex flex-col items-center flex-1 max-w-2xl px-8">
                        <div className="flex items-center gap-6 mb-1">
                            ...
                            <button
                                ...
                                className="w-10 h-10 bg-[#8B5CF6] rounded-full flex items-center justify-center text-white hover:scale-105 transition shadow-[0_0_15px_rgba(139,92,246,0.4)] focus-visible:ring-2 focus-visible:ring-[#8B5CF6] focus-visible:ring-offset-2 focus-visible:ring-offset-black focus-visible:outline-none"
                                onClick={togglePlay}
                                disabled={isLoading}
                            >
                                {isLoading ? (
                            ...
                            <button
                                aria-label={`Repeat ${repeat === 'off' ? 'off' : repeat === 'one' ? 'one track' : 'all tracks'}`}

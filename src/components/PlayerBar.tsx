                    ...
                    <div className="flex items-center gap-4 w-1/4 min-w-[200px]">
                        ...
                        <div className="flex flex-col min-w-0">
                            <div className="flex items-center gap-2">
                                ...
                                <button onClick={() => toggleLike(currentTrack)} aria-label={liked ? "Remove from favorites" : "Add to favorites"}>
                    ...
                    <div className="flex flex-col items-center flex-1 max-w-2xl px-8">
                        <div className="flex items-center gap-6 mb-1">
                            ...
                            <button
                                ...
                                aria-label={repeat === 'one' ? "Repeat all" : repeat === 'all' ? "Disable repeat" : "Repeat one"}
                            >
                        ...
                        <div className="w-full flex items-center gap-3 text-xs font-medium text-gray-400">
                            ...
                            <div
                                ...
                                onKeyDown={(e) => {
                                    ...
                                    if (e.key === 'ArrowRight') {
                                        e.preventDefault();
                                        seekTo(Math.min(duration, currentTime + skipAmount));
                                    } else if (e.key === 'ArrowLeft') {
                                        e.preventDefault();
                                        seekTo(Math.max(0, currentTime - skipAmount));
                                    }
                                }}
                            >

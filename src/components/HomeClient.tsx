...
interface HomeClientProps {
    heroData?: any;
    dailyMixPreviews?: { [key: string]: any[] };
    recommendedTracks?: any[];
    quickPicksTracks?: any[];
}
      ...
      <div suppressHydrationWarning className="px-4 md:px-8 pb-32 space-y-12 pt-4 md:pt-8 transition-all">
        ...
        {selectedGenre === 'All' ? (
          <div className="space-y-20 animate-in fade-in duration-700 delay-100">
            <Hero initialTrack={heroData} />

            <div className="space-y-24">
              <DailyMixes prefetchedPreviews={dailyMixPreviews} />

              <RecommendedGrid initialTracks={recommendedTracks} />
              <QuickPicks initialTracks={quickPicksTracks} />
              <MusicVideos />
              <ListenAgain />
            </div>
          </div>

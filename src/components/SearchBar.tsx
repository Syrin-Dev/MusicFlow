            ...
            <form onSubmit={handleSearch} className="relative group" role="search">
                ...
                {query && (
                    <button
                        ...
                        className="absolute right-4 top-1/2 -translate-y-1/2 p-1 rounded-full hover:bg-white/10 text-zinc-400 hover:text-white transition-colors focus-visible:ring-2 focus-visible:outline-none"
                    >

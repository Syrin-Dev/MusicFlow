        ...
        <div suppressHydrationWarning className="fixed bottom-0 left-0 right-0 z-50 pointer-events-none">
                    ...
                    <div className="flex items-center gap-4 w-1/4 min-w-[200px]">
                        <div className="relative group">
                            ...
                            <button
                                ...
                                className="absolute inset-0 bg-black/40 hidden group-hover:flex items-center justify-center rounded-lg transition cursor-pointer border-none p-0"
                        ...
                        <div className="flex flex-col min-w-0">
                            <div className="flex items-center gap-2">
                                <button
                                    type="button"
                                    className="text-white font-bold text-sm hover:underline cursor-pointer truncate max-w-[150px] text-left appearance-none bg-transparent border-none p-0"
                                    onClick={togglePlayerExpansion}
                                >
                                    {currentTrack.title}
                                </button>
                            ...
                            <button
                                type="button"
                                className="text-xs text-gray-400 hover:text-white cursor-pointer hover:underline truncate text-left appearance-none bg-transparent border-none p-0"
            ...
            <div className="flex md:hidden px-2 pb-[calc(70px+16px+12px+env(safe-area-inset-bottom))] w-full">
                ...
                >
                    ...
                    <button
                        className="flex items-center gap-3 min-w-0 flex-1 text-left appearance-none bg-transparent border-none p-0"
                        onClick={togglePlayerExpansion}
                        aria-label="Expand player"
                    >
                        <img

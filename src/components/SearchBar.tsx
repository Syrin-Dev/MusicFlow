    ...
    return (
        <div ref={wrapperRef} className="relative w-full z-40 max-w-2xl">
            <form onSubmit={handleSearch} className="relative group" role="search">
                <label htmlFor="search-input" className="sr-only">Search for songs, artists, or podcasts</label>
                ...
                {query && (
                    <button
                        ...
                        className="absolute right-4 top-1/2 -translate-y-1/2 p-1 rounded-full hover:bg-white/10 text-zinc-400 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
                    >

    ...
    return (
        <div suppressHydrationWarning className="fixed bottom-0 left-0 right-0 z-50 pointer-events-none">
                ...
                <div className="backdrop-blur-md bg-black/20 border border-white/5 rounded-2xl p-3 flex items-center justify-between shadow-[0_8px_32px_rgba(0,0,0,0.5)] pointer-events-auto mx-auto max-w-screen-2xl w-full">
                    ...
                    <div className="flex items-center gap-4 w-1/4 min-w-[200px]">
                        <div className="relative group">
                            ...
                            />
                            <button
                                className="absolute inset-0 bg-black/40 hidden group-hover:flex items-center justify-center rounded-lg transition cursor-pointer border-none p-0 w-full h-full"
                        ...
                        <div className="flex flex-col min-w-0">
                            <div className="flex items-center gap-2">
                                <button
                                    className="text-white font-bold text-sm hover:underline cursor-pointer truncate max-w-[150px] bg-transparent border-none p-0 text-left"
                                    onClick={togglePlayerExpansion}
                                    title="Expand player"
                                >
                                    {currentTrack.title}
                            ...
                            <button
                                className="text-xs text-gray-400 hover:text-white cursor-pointer hover:underline truncate bg-transparent border-none p-0 text-left"
                    ...
                    <div className="flex flex-col items-center flex-1 max-w-2xl px-8">
                        <div className="flex items-center gap-6 mb-1">
                            ...
                            <button
                                ...
                                aria-label={`Repeat mode: ${repeat === 'off' ? 'off' : repeat}`}
                                title={`Repeat mode: ${repeat === 'off' ? 'off' : repeat}`}
                            >
            ...
            <div className="flex md:hidden px-2 pb-[calc(70px+16px+12px+env(safe-area-inset-bottom))] w-full">
                {/* Glassmorphism update: Added backdrop-blur-md and bg-black/20 */}
                <div
                    className="backdrop-blur-md bg-black/20 rounded-xl p-2 flex items-center justify-between shadow-2xl pointer-events-auto border border-white/5 w-full relative overflow-hidden cursor-pointer"
                    onClick={togglePlayerExpansion}
                >

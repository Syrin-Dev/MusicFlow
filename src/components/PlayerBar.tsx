                ...
                <div className="backdrop-blur-md bg-black/20 border border-white/5 rounded-2xl p-3 flex items-center justify-between shadow-[0_8px_32px_rgba(0,0,0,0.5)] pointer-events-auto mx-auto max-w-screen-2xl w-full">
                    ...
                    <div className="flex items-center gap-4 w-1/4 min-w-[200px]">
                        ...
                        <div className="flex flex-col min-w-0">
                            <div className="flex items-center gap-2">
                                ...
                                <button onClick={() => toggleLike(currentTrack)} aria-label={liked ? 'Unlike' : 'Like'}>
                    ...
                    <div className="flex flex-col items-center flex-1 max-w-2xl px-8">
                        ...
                        <div className="w-full flex items-center gap-3 text-xs font-medium text-gray-400">
                            ...
                            <div
                                className="flex-1 h-1 bg-white/10 rounded-full cursor-pointer group relative overflow-hidden outline-none focus-visible:ring-2 focus-visible:ring-[#8B5CF6]"
                                onClick={handleSeek}
                                role="slider"
                                tabIndex={0}
                                ...
                                onKeyDown={(e) => {
                                    ...
                                    else if (e.key === 'ArrowLeft') seekTo(Math.max(0, currentTime - 5));
                                }}
                            >
                    ...
                    <div className="flex items-center justify-end gap-3 w-1/4 min-w-[200px]">
                        <button
                            className="text-gray-400 hover:text-[#8B5CF6] transition p-2 hover:bg-white/5 rounded-full outline-none focus-visible:ring-2 focus-visible:ring-[#8B5CF6]"
                        ...
                        <button
                            className="text-gray-400 hover:text-white transition ml-2 outline-none focus-visible:ring-2 focus-visible:ring-[#8B5CF6]"
                            onClick={togglePlayerExpansion}
                            title="Expand player"
            ...
            <div className="flex md:hidden px-2 pb-[calc(70px+16px+12px+env(safe-area-inset-bottom))] w-full">
                ...
                >
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <button
                            className="w-10 h-10 flex items-center justify-center text-white outline-none focus-visible:ring-2 focus-visible:ring-white rounded-full"
                            onClick={(e) => {
                                e.stopPropagation();
                                togglePlay();
                            }}
